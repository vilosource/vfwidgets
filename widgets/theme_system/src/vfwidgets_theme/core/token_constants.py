...
class Tokens:
    ...
    # ============================================================================
    TERMINAL_BACKGROUND = "terminal.colors.background"
    TERMINAL_FOREGROUND = "terminal.colors.foreground"
    ...
    TERMINAL_ANSI_BLACK = "terminal.colors.ansiBlack"
    TERMINAL_ANSI_RED = "terminal.colors.ansiRed"
    TERMINAL_ANSI_GREEN = "terminal.colors.ansiGreen"
    TERMINAL_ANSI_YELLOW = "terminal.colors.ansiYellow"
    TERMINAL_ANSI_BLUE = "terminal.colors.ansiBlue"
    TERMINAL_ANSI_MAGENTA = "terminal.colors.ansiMagenta"
    TERMINAL_ANSI_CYAN = "terminal.colors.ansiCyan"
    TERMINAL_ANSI_WHITE = "terminal.colors.ansiWhite"
    TERMINAL_ANSI_BRIGHT_BLACK = "terminal.colors.ansiBrightBlack"
    TERMINAL_ANSI_BRIGHT_RED = "terminal.colors.ansiBrightRed"
    TERMINAL_ANSI_BRIGHT_GREEN = "terminal.colors.ansiBrightGreen"
    TERMINAL_ANSI_BRIGHT_YELLOW = "terminal.colors.ansiBrightYellow"
    TERMINAL_ANSI_BRIGHT_BLUE = "terminal.colors.ansiBrightBlue"
    TERMINAL_ANSI_BRIGHT_MAGENTA = "terminal.colors.ansiBrightMagenta"
    TERMINAL_ANSI_BRIGHT_CYAN = "terminal.colors.ansiBrightCyan"
    TERMINAL_ANSI_BRIGHT_WHITE = "terminal.colors.ansiBrightWhite"
