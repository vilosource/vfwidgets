...
class TestTokenColorMapper:
    ...
    def test_token_color_validation(self):
        ...
        vscode_tokens = [
            # Valid token
            {"name": "Valid", "scope": "valid.scope", "settings": {"foreground": "#ffffff"}},
            # Invalid tokens
            {
                "name": "No scope"
                # Missing scope
            ...
            {"scope": "empty.settings", "settings": {}},  # Empty settings
            "invalid_format",  # Not a dict
            {"scope": None, "settings": {"foreground": "#000000"}},  # Invalid scope type
        ]
    ...
    def test_scope_normalization(self):
        ...
        vscode_tokens = [
            {"scope": "single.scope", "settings": {"foreground": "#111111"}},
            {"scope": ["multiple", "scopes"], "settings": {"foreground": "#222222"}},
            {
...
class TestVSCodeImporter:
    ...
    def test_import_summary(self):
        ...
        vscode_data = {
            "name": "Test Theme",
            "colors": {"editor.background": "#1e1e1e", "unknown.color": "#123456"},
        }
