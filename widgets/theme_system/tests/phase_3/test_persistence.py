...
class TestThemeValidator:
    ...
    def test_valid_theme_passes_validation(self):
        ...
        theme_data = {
            "name": "Test Theme",
            "version": "1.0.0",
            "properties": {"window.background": "#ffffff", "window.foreground": "#000000"},
    ...
    def test_invalid_version_type_fails_validation(self):
        ...
        theme_data = {"name": "Test Theme", "version": 123, "properties": {}}  # Should be string
...
class TestThemeMigrator:
    ...
    def test_current_version_theme_no_migration(self):
        ...
        theme_data = {"version": "1.0.0", "name": "Test Theme", "properties": {}}
    ...
    def test_v09_theme_migration(self):
        ...
        old_theme_data = {
            "version": "0.9",
            "name": "Old Theme",
            "properties": {"window.background": "#ffffff"},
        }
    ...
    def test_unsupported_version_raises_error(self):
        ...
        theme_data = {"version": "999.0", "name": "Future Theme"}
    ...
    def test_detect_version_legacy(self):
        ...
        legacy_data = {"properties": {}}  # No version field, but has properties
...
class TestThemePersistence:
    ...
    def test_save_and_load_theme_success(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            theme = Theme(
                name="Test Theme",
                colors={"window.background": "#ffffff", "window.foreground": "#000000"},
            )
    ...
    def test_save_compressed_theme(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            theme = Theme(name="Compressed Theme", styles={"test.property": "value"})
    ...
    def test_migration_during_load(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            assert "old.property" in loaded_theme.colors or "old.property" in loaded_theme.styles
