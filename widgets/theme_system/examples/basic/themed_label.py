...
class ThemedLabel(ThemedWidget, QLabel):
    ...
    def update_styling(self):
        ...
        if self._label_type == 'title':
            color = self.theme.get(f'text.title.color', base_color)
            ...
            color = self.theme.get(f'text.subtitle.color', base_color)
            ...
            color = self.theme.get(f'text.caption.color', '#666666')
