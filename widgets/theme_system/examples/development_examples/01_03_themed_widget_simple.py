...
try:
    from PySide6.QtWidgets import QVBoxLayout, QHBoxLayout, QPushButton, QLabel, QMainWindow
...
class SimpleThemedPanel(ThemedWidget):
    ...
    def __init__(self, parent=None):
        ...
        print(f"   - Child widgets automatically themed")
...
class SimpleExample:
    ...
    def __init__(self):
        ...
        print(f"✅ ThemedApplication created")
