...
# Task 12 imports
from vfwidgets_theme.events.system import ThemeEventSystem, get_global_event_system
# Task 14 imports
from vfwidgets_theme.patterns.matcher import (
    PatternMatcher, PatternType, PatternPriority,
    glob_pattern, regex_pattern, widget_name_pattern, widget_type_pattern
)
from vfwidgets_theme.patterns.plugins import (
    StatePlugin, HierarchyPlugin, GeometryPlugin
)
...
class ValidatedWidget(ThemedWidget):
    ...
    def on_theme_changed(self):
        ...
        print(f"ValidatedWidget theme changed:")
