...
title = Reamde
project_dir = .
input_file = /home/kuja/GitHub/vfwidgets/apps/reamde/reamde_main.py
exec_directory = .
...
packages = PySide6==6.9.0,vfwidgets-theme-system,chrome-tabbed-window,vfwidgets-markdown,vfwidgets-vilocode-window,vfwidgets-common
...
extra_args = --nofollow-import-to=pytest --nofollow-import-to=black --nofollow-import-to=ruff --nofollow-import-to=mypy --include-package-data=vfwidgets_markdown --include-package-data=vfwidgets_theme
