#!/bin/bash
# ViloxTerm User-Level Uninstallation Script
# Removes ViloxTerm from user directories
#
...
echo "=========================================="
echo "ViloxTerm User Uninstallation"
echo "=========================================="
echo ""
...
for size in scalable 16x16 22x22 24x24 32x32 48x48 64x64 128x128 256x256 512x512; do
    if [ "$size" = "scalable" ]; then
        ICON_PATH="$ICON_DIR/$size/apps/viloxterm.svg"
    else
        ICON_PATH="$ICON_DIR/$size/apps/viloxterm.png"
    fi
...
if [ $REMOVED -eq 1 ]; then
    ...
    echo "=========================================="
    echo ""
    echo "ViloxTerm has been removed from your user directories."
    echo ""
    ...
    echo "=========================================="
    echo ""
    echo "ViloxTerm was not found in user directories."
